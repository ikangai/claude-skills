...
| [omakase](./omakase/) | Chef's-choice build workflow for fuzzy software requests: reads the brief as a mood, states its assumptions as a vetoable menu, serves a runnable first bite, offers three concrete tastings at every taste fork, then runs a mandatory simplify pass and an independent second opinion before plating. |
